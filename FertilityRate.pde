class FertilityRate extends Visual{
  
  final String header = "FertilityRate_";
  
  //Year Interval for X axis
  final int yearInterval = 10;
  
  //Major tick interval (eg: 30, 40, 50...)
  final float yMajorIntervalTick = 1;
  //Minor tick interval (eg: 35, 45, 55..)
  final float yMinorIntervalTick = 0.5;
  
  //Holds the min and max value from overall FertilityRate columns
  float minYVal = 0.0;
  float maxYVal = 0.0;
    
  FertilityRate(String t, String d, String labelX, String labelY, boolean clicked,  boolean gridFlag, PShape cm, ArrayList<Country> c){
    super(t, d, labelX, labelY, clicked, gridFlag, cm,c);
  }
  
  //Overload the constructor because we want data in this class
  FertilityRate(String t, String d, String labelX, String labelY, boolean clicked,  boolean gridFlag, Table data, PShape cm, ArrayList<Country> c){
